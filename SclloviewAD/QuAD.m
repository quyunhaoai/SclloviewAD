...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        [self peizi];
        self.backgroundColor =[UIColor colorWithRed:(40/255.0f) green:(40/255.0f) blue:(40/255.0f) alpha:0.8f];
    }
    return self;
}
-(void)peizi{
...
-(void)tap{
    ...
    //开始动画
    [UIView beginAnimations:@"one" context:nil];
    //设置时常
...
-(void)dianji{
    ...
    //开始动画
    [UIView beginAnimations:@"tow" context:nil];
    //设置时常
    [UIView setAnimationDuration:0.3];
    //设置动画淡入淡出
    [UIView setAnimationCurve:UIViewAnimationCurveLinear];
...
{
    //开始动画
    [UIView beginAnimations:@"three" context:nil];
    //设置时常
    [UIView setAnimationDuration:0.3];
    //设置动画淡入淡出
    [UIView setAnimationCurve:UIViewAnimationCurveLinear];
